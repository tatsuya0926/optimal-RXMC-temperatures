...
function initial_state(N; p=1.0)
    ...
    return ifelse.(rand(N, N, N) .< p, 1, -1)
end
...
export initial_state, metropolis_sampler, calc_energy, calc_gradient_no_constraints, calc_gradient, calc_round_trip_times
